...
import com.fallgan.customerapp.adapter.OfferAdapter
import com.fallgan.customerapp.model.HomeOffer
...
class ApiConfig : Application() {
    ...
    companion object {
        ...
        fun requestToVolley(callback: VolleyCallback, activity: Activity, url: String, params: MutableMap<String, String>, isProgress: Boolean
        ) {
